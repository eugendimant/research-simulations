...
### Tier 2: Adaptive Behavioral Engine 2.0 (Fallback / Standalone)

When selected as the primary method or when AI providers are unavailable, the system uses the **Adaptive Behavioral Engine 2.0** — a narrative-enhanced wrapper around the 225+ domain template engine. As of v1.2.3.1, the engine uses a **compositional architecture** with dedicated narrative intent builders (Brotherton 2013, Pennebaker 1997, Green & Brock 2000) that produces highly varied, topic-grounded responses:
...
2. **Two simultaneous recovery options** presented as equal choices:
   ...
   - **Adaptive Behavioral Engine 2.0**: Complete remaining participants with the narrative-enhanced 225+ domain engine — runs entirely offline, no API needed
...
4. **Source transparency**: The final dataset includes metadata showing which responses were AI-generated vs. ABE 2.0-generated
