...
**Version 1.4.9** | A Streamlit application for generating realistic synthetic behavioral experiment data using theory-grounded persona-driven simulation.
...
### NEW: LLM-Powered Open-Ended Responses (v1.4.9)
