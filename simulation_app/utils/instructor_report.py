    ...
    def generate_markdown_report(
        ...
        if open_ended_details:
            ...
            if pool_size > 0:
                ...
                lines.append("**Generation approach:** Template-Based (with AI attempted)")
                lines.append("")
                lines.append(f"- {llm_calls} API call(s) were attempted but did not produce usable responses")
...
class ComprehensiveInstructorReport:
    ...
    def generate_html_report(
        ...
        if oe_questions:
            ...
            elif llm_calls_html > 0:
                # API was called but no usable responses were produced
                html_parts.append("<p><strong>Generation approach:</strong> Template-Based (AI attempted)</p>")
