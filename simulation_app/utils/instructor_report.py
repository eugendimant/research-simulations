...
__version__ = "1.4.9"  # v1.4.9: Multi-provider auto-detect, improved report quality
    ...
    def generate_markdown_report(
        ...
        if open_ended_details:
            ...
            if llm_calls > 0:
                ...
                lines.append("")
                lines.append("- Responses were generated by a large language model tailored to your study's questions and conditions")
                if pool_size > 0:
                ...
                if fallback_uses > 0:
                    ...
                    if pct > 50:
                        ...
                        lines.append(f"- {fallback_uses} response(s) ({pct:.0f}%) used template fallback due to API limits")
            else:
                lines.append("**Generation approach: Template-Based**")
                lines.append("")
