    ...
    if _has_open_ended and not _is_generating and not _has_generated:
        ...
        if _llm_status.get("available"):
            ...
            st.markdown(
                ...
                'Without an AI key, open-ended responses use an optimized template system '
                'with 225+ research domains and 40 question types — still producing '
                'realistic, varied participant responses.</span></div>',
                unsafe_allow_html=True,
            )
