...
REQUIRED_UTILS_VERSION = "1.0.8.9"
BUILD_ID = "20260214-v10890-socsim-strategy-expansion"  # Change this to force cache invalidation
...
APP_VERSION = "1.0.8.9"  # v1.0.8.9: SocSim strategy models, agent backends, optimization infrastructure
