...
REQUIRED_UTILS_VERSION = "1.0.7.8"
BUILD_ID = "20260213-v10708-gitignore-backups"  # Change this to force cache invalidation
...
APP_VERSION = "1.0.7.8"  # v1.0.7.8: Add _backups/ to .gitignore
