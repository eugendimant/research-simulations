...
REQUIRED_UTILS_VERSION = "1.0.7.5"
BUILD_ID = "20260213-v10705-fix-version-sync-all-locations"  # Change this to force cache invalidation
...
APP_VERSION = "1.0.7.5"  # v1.0.7.5: Fix version mismatch across all 9 locations
