...
REQUIRED_UTILS_VERSION = "2.2.8"
BUILD_ID = "20260203-v228-full-domain-calibration"  # Change this to force cache invalidation
...
APP_VERSION = "2.2.8"  # FULL DOMAIN: All personas calibrated with scientific methods across all domains
